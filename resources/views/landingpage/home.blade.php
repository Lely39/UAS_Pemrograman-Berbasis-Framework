                          ...
                          <div class="row d-flex align-items-center">
                              <div class="col-md-6">
                                  <div class="banner-content">
                                      <h1 class="display-2 text-uppercase text-dark pb-5">Produk Terbaik untuk Anda</h1>
                                      <a href="shop.html"
                  ...
                  <div class="swiper-slide">
                      <div class="container">
                          <div class="row d-flex flex-wrap align-items-center">
                              <div class="col-md-6">
                                  <div class="banner-content">
                                      <h1 class="display-2 text-uppercase text-dark pb-5">Teknologi Modern & Berkualitas</h1>
                                      <a href="shop.html"
                                          class="btn btn-medium btn-dark text-uppercase btn-rounded-none"> Lihat Produk</a>
                                  </div>
                              </div>
                              <div class="col-md-5">
                                  <div class="image-holder">
                  ...
                  <div class="col-lg-3 col-md-6 pb-3">
                      <div class="icon-box d-flex">
                          ...
                          <div class="icon-box-content">
                              ...
                              <p>Produk original dengan standar kualitas terbaik.</p>
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 pb-3">
                      <div class="icon-box d-flex">
                          ...
                          <div class="icon-box-content">
                              <h3 class="card-title text-uppercase text-dark">Promo Harian</h3>
                              <p>Dapatkan penawaran menarik setiap hari.</p>
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 pb-3">
                      <div class="icon-box d-flex">
                          ...
                          <div class="icon-box-content">
                              <h3 class="card-title text-uppercase text-dark">Pembayaran Aman</h3>
          ...
          <div class="container">
              <div class="row">
                  <div class="display-header d-flex justify-content-between pb-3">
                      <h2 class="display-7 text-dark text-uppercase"> Produk Elektronik</h2>
                      <div class="btn-right">
                          <a href="shop.html" class="btn btn-medium btn-normal text-uppercase">   Lihat Semua</a>
                      </div>
                  </div>
<div class="swiper product-swiper">
    <div class="swiper-wrapper" id="produkElektronik">
        <!-- DATA DARI API AKAN MASUK KE SINI -->
    </div>
</div>
                              ...
                              <div class="swiper-slide text-center d-flex justify-content-center">
                                  <div class="review-item col-md-10">
                                      ...
                                      <blockquote>“Tempus oncu enim pellen tesque este pretium in neque, elit morbi sagittis
                                          ...
                                          lorem habi tasse morbi.”</blockquote>
                                      <div class="rating">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://127.0.0.1:8000/api/elektronik")
        .then(response => response.json())
        .then(data => {

            const wrapper = document.getElementById("produkElektronik");
            wrapper.innerHTML = "";
            ...
            data.forEach(item => {
                ...
                wrapper.innerHTML += `
                    <div class="swiper-slide">
                        <div class="product-card pt-3 text-center">
                            ...
                            <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                <h3 class="card-title text-uppercase"
                                    style="font-size:0.85rem; font-weight:600; line-height:1.3; margin-bottom:4px;">
                                    ${item.nama_barang}
                                </h3>
            ...
            // RE-INIT SWIPER SETELAH DATA MASUK
